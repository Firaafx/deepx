            ...
            child: SizedBox(
              ...
              child: Material(
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, _) {
                    final double travel = (_shineController.value * 2.4) - 1.2;
                    return ClipRRect(
  ...
  Widget build(BuildContext context) {
    ...
    final preview = previewPayload.isEmpty
        ...
        : _OverlayParallaxPreview(
            key: ValueKey<String>(
              'collection-grid-preview-${summary.id}-${summary.updatedAt.millisecondsSinceEpoch}',
            ),
            mode: previewMode,
...
class _FeedTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget layeredPreview = _OverlayParallaxPreview(
      key: ValueKey<String>(
        'home-grid-preview-${post.preset.id}-${post.preset.updatedAt.millisecondsSinceEpoch}',
      ),
      mode: previewMode,
      payload: previewPayload,
      borderRadius: cardRadius,
                  ...
                  children: [
                    AspectRatio(
                      ...
                      child: ClipRRect(
                        ...
                        child: _OverlayParallaxPreview(
                          key: ValueKey<String>(
                            'profile-post-preview-${preset.id}-${preset.updatedAt.millisecondsSinceEpoch}',
                          ),
                          mode: mode,
                          payload: payload,
                          borderRadius: BorderRadius.circular(8),
                              ...
                              children: [
                                AspectRatio(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: _OverlayParallaxPreview(
                                      key: ValueKey<String>(
                                        'profile-saved-preview-$kind-$entityId-${(entry['createdAt'] as DateTime).millisecondsSinceEpoch}',
                                      ),
                                      mode: mode,
                                      payload: payload,
                                      borderRadius: BorderRadius.circular(8),
